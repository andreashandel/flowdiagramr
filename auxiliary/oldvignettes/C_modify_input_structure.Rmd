...
modified_diagram_list$variables$xmin[2] = 2
modified_diagram_list$variables$xmax[2] = 5
#modify inflow and outflow arrows to align with new box size 
modified_diagram_list$flows$xmax[1] = 2
modified_diagram_list$flows$xmin[2] =5
#move the b*S*I arrow end a bit
modified_diagram_list$flows$xmax[7] = 1.5
#move the b*S*I label 
modified_diagram_list$flows$ylabel[7] = 1.25
modified_diagram_list$flows$xlabel[7] = 2
#move the g*I arrow over just a bit
modified_diagram_list$flows$xlabel[2] = 5.5
```
...
```{r}
#increase boxes
diagram_list$variables$xmin[1] = -0.25
diagram_list$variables$xmax[1] = 1.25
diagram_list$variables$xmin[2] = 2.75
diagram_list$variables$xmax[2] = 4.25
#relabel boxes
diagram_list$variables$label[1] = "Pat \n (Bacteria)"
diagram_list$variables$label[2] = "Imm \n (T cells)"
#adjust arrow locations to start/end at box edges
diagram_list$flows$xmin[6] <- 2.75
diagram_list$flows$xmin[7] <- 1.25
diagram_list$flows$xmax[7] <- 3.2
#move k*Pat*Imm label
diagram_list$flows$ylabel[6] <- 0.1
#change label
