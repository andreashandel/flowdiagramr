...
model_settings <- list(varlocations = structure(c("S", "", "", "I", "R", ""), .Dim = 2:3), varbox_x_size = 1, varbox_y_size = 1, varspace_x_size = 1, varspace_y_size = 1)
...
variables <- data.frame(
  ...
  ymin = c(3, 0, 3),
  ymax = c(4, 1, 4),
  xlabel = c(0.5, 3.5, 6.5),
  ylabel = c(3.5, 0.5, 3.5),
  color = c(NA, NA, NA),
