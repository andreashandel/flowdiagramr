...
#' result <- simulate_Influenza_OAS_simpleModel_ode() 
#' # To choose values other than the standard one, specify them like this:  
#' result <- simulate_Influenza_OAS_simpleModel_ode(Hf = 20000,Hb = 0,B1 = 200,A1 = 200,B2 = 20,A2 = 20) 
...
simulate_Influenza_OAS_simpleModel_ode <- function(Hf = 10000, Hb = 0, B1 = 100, A1 = 100, B2 = 10, A2 = 10, k1 = 0.01, k2 = 0.02, df = 0.5, db = 0.7, s1 = 1, p1 = 1000, g1 = 0.1, d1 = 0.1, s2 = 0.5, p2 = 1000, g2 = 0.1, d2 = 0.1, tstart = 0, tfinal = 100, dt = 0.1) 
{ 
  ############################## 
  #Block of ODE equations for deSolve 
  ############################## 
  Influenza_OAS_simpleModel_ode_fct <- function(t, y, parms) 
  {
  ...
  parvec_mb = c(k1 = k1, k2 = k2, df = df, db = db, s1 = s1, p1 = p1, g1 = g1, d1 = d1, s2 = s2, p2 = p2, g2 = g2, d2 = d2) 
  timevec_mb = seq(tstart, tfinal,by = dt) 
  #Running the model 
  simout = deSolve::ode(y = varvec_mb, parms = parvec_mb, times = timevec_mb,  func = Influenza_OAS_simpleModel_ode_fct, rtol = 1e-10, atol = 1e-10) 
