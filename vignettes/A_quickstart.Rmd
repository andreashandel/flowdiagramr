...
It is possible to change the look of the diagram fairly easily using the `update_diagram()` function. You'll learn more about this [in the next vignette](./B_modify_diagrams_simple.html). Here is a quick preview. You provide the `update_diagram()` function with the `diagram_list` object produced by `make_diagram()` 
...
```{r}
variables = c("Sc","Ic","Rc","Sa","Ia","Ra","P")
flows_wrong2 = list(Sc_flows = c("-Sc*bcc*Ic","-Sc*bca*Ia","-Sc*bcp*P"),
             Ic_flows = c("Sc*bcc*Ic","Sc*bca*Ia","Sc*bcp*P","-gc*Ic"),
             Rc_flows = c("gc*Ic"),
             Sa_flows = c("-Sa*bac*Ic","-Sa*baa*Ia","-Sa*bap*P"),
             Ia_flows = c("-Sa*bac*Ic","-Sa*baa*Ia","-Sa*bap*P","-ga*Ia"),
