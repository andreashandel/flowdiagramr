...
**I first wrote the model like this. Then realized that having the flows together won't work.**
...
**This model is wrong, I accidentally left the minus signs in the Ia flows. prepare_diagram produces a very confusing error message.** 
...
**This works. I labeled the pathogen creation parameters sc and sa, and then realized that I have compartments Sc and Sa. So this is not good nomenclature (and I'll likely change for final example), but I wanted to see if it works, and it does, which is good.**
