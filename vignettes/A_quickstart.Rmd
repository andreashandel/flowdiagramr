...
**CHECK THAT ABOVE IS CORRECT AND CORRESPONDS TO CHECKS IN THE FUNCTION THAT CHECKS VALIDITY OF MODEL. ALSO, ONCE CHECKED, LET'S MAKE prepare_diagram HELP FILE AND THIS TEXT CONSISTENT SO BOTH PLACES EXPLAIN ALL.**
...
my_diagram <- make_diagram(
  ...
  diagram_settings = list(var_fill_color = c('blue','red'),
                          ...
                          interaction_flow_linetype = "solid"
                          )
)
