...
THIS SHOULD GO INTO HELP FILE. THEN DELETE FROM HERE, SO WE ONLY HAVE IN ONE PLACE.
...
diagram_list_modified$nodes$x[3] = 13 
```
...
Sure enough, if you plot this now, the parameter is labeled as you wanted, showing `Pmax` instead of `pmax`.
