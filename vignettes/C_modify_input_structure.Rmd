...
diagram_list$flows$xstart[3] <- 0.75
...
The main problems are the location of the labels, so we'll focus on moving them around.
...
diagram_list$flows$labelx[13] <- 3.5
diagram_list$flows$label7[13] <- -3
```
