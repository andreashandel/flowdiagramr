...
modified_diagram_list$flows$xend[3] = 4
#move the b*S*I label 
modified_diagram_list$flows$labely[3] = 0.2
modified_diagram_list$flows$labelx[3] = 4.6
...
diagram_list$flows$xstart[4] <- 2.25
#move labels
diagram_list$flows$labelx[4] <- 2
diagram_list$flows$labelx[4] <- 1.4
#change label
