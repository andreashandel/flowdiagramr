...
The ability to adjust the layout becomes especially important once the model gets bigger. Let's look at this for the last model shown in the _Getting Started_ vignette. Here is the model again, this time with locations specified. We place the 2 *SIR* compartments on the top and the bottom, and the **P** compartment in the middle.
