...
```{r, fig.height=5}
sir_vertical <- prepare_diagram(model_list = sirmodel, model_settings = sir_vertical_settings)
...
sir_vertical2 <- prepare_diagram(model_list = sirmodel, model_settings = sir_vertical_settings2)
...
```{r, eval = FALSE}
sir_vertical_settings2 = list(varlocations = matrix(data = c("S", "I", "R"), nrow = 3,  byrow = TRUE),
                   varbox_x_scaling = c(1.5,1,1.5),
                   varbox_y_scaling = c(0.5,1,0.5),
                   varspace_y_scaling = c(0.5,1,0.5)
                   )
sir_vertical2 <- prepare_diagram(model_list = sirmodel, model_settings = sir_vertical_settings2)
sir_diagram <- make_diagram(diagram_list = sir_vertical2)
plot(sir_diagram)
...
my_model_settings = list(  varbox_x_scaling = 4,
                           varspace_x_scaling = 0.5
                        )
#prepare diagram
...
#specify extra settings for prepare_diagram
my_model_settings = list(  varbox_x_scaling = 6,
                           varspace_x_scaling = 0.5
                        )
#prepare diagram
