...
my_diagram <- make_diagram(diagram_list, diagram_settings = list(use_varnames = TRUE))
plot(my_diagram)
```
...
# apply some styling
diagram_settings <- list(node_text_size = 3,
                          flow_text_size= 4,
                          node_text_color = "black",
                          node_fill_color = c("pink", "yellow", "yellow",
                                              "green", "green", "green"),
