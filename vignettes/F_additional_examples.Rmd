...
flows = list(U_flows = c("-b*U*V"),
             ...
             # V_flows = c("p*I", "-dV*V")
            V_flows = c("p*I", "-dV*V","-b*U*V") #original
)
...
dlist2 <- update_diagram(dlist,list(flow_show_arrow = c(all = FALSE)))
...
```{r}
variables = c("U","I","V")
flows = list(U_flows = c("n","-dU*U","-g*b*U*V"),
             I_flows = c("g*b*U*V","-dI*I"),
             # V_flows = c("p*I", "-dV*V")
