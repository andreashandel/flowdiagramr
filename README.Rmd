...
For an introduction to the package, step-by-step instructions on getting started, and more information on the different ways you can use the package [see the _Quick Start_ tutorial (vignette)](./articles/A_quickstart.html).
